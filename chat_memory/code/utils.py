"""
File: utils.py
Description: Utility functions for loading configurations, environment variables, and saving text files.
...
from paths import DATA_DIR, ENV_FPATH, PUBLICATION_FPATH
